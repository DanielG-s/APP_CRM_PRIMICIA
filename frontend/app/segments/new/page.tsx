        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3 mt-2">
            <div className="bg-indigo-50 p-3 rounded-lg border border-indigo-100">
              <div className="font-bold text-indigo-700 text-sm">🧩 Blocos</div>
              <div className="text-xs text-indigo-600">Combine RFM, Comportamento e Dados.</div>
            </div>
            <div className="bg-emerald-50 p-3 rounded-lg border border-emerald-100">
              <div className="font-bold text-emerald-700 text-sm">⚡ Automação</div>
              <div className="text-xs text-emerald-600">Segmentos dinâmicos alimentam seus fluxos.</div>
            </div>
          </div>
        </div>
      ),
    ...
    <div className="flex h-screen bg-gray-50 font-sans text-slate-900">
      <main className="flex-1 flex flex-col h-screen overflow-hidden ml-20 md:ml-64 transition-all duration-300">
        ...
        <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-8 shadow-sm shrink-0">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => setIsTutorialOpen(true)} className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100 text-slate-600 hover:bg-slate-200 transition-colors text-xs font-bold mr-2 cursor-pointer"><BookOpen size={16} className="text-indigo-500" /> Como usar?</button>
